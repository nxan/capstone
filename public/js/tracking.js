...
$(document).ready(() => {
    ...
    $(window).bind("beforeunload", function () {
        ...
        navigator.sendBeacon('https://f3e92b74.ngrok.io/api/page/sendHeatMap', data);
    })
    ...
    setInterval(function () {
        fetch('https://f3e92b74.ngrok.io/api/session/save/resave', {
...
function save_session(set) {
    if (!save) {
        if (document.visibilityState === 'visible') {
            fetch('https://f3e92b74.ngrok.io/api/session', {
