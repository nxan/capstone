...
class LoginLayout extends React.PureComponent {
    ...
    toggleBackground = () => {
        const { backgroundEnable } = this.state
        this.setState({
    ...
    render() {
        ...
        const { backgroundNumber, backgroundEnable } = this.state

        return (
            <Layout>
                <Layout.Content>
                    <div
                        className={backgroundEnable ? `${styles.layout} ${styles.light}` : `${styles.layout}`}
                        style={{
                            backgroundImage: backgroundEnable
