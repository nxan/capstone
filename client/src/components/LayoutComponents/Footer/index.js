    ...
    <div className={styles.inner}>
      <div className="row">
        <div className="col-lg-9">
          <p>
            <strong>Shopify Analytics - Best Solution for Your App!</strong>
          </p>
          <p>
          Shopify Analytics – a modern professional admin template, based on Bootstrap 4 framework. Clean
            UI is a powerful and super flexible tool, which suits best for any kind of web
            application: Web Applications; CRM; CMS; Admin Panels; Dashboards; etc. Shopify Analytics is
            fully responsive, which means that it looks perfect on mobiles and tablets.
          </p>
          <p>
          Shopify Analytics is fully based on SASS pre-processor, includes 50+ commented SASS files. Each
